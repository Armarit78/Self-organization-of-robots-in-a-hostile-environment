...
def run_benchmark(n_runs=30, seed_start=100):
    ...
    write_detailed_csv(rows, "Version 2 - Contamination/results/benchmark_results_detailed.csv")
    write_summary_csv(rows, "Version 2 - Contamination/results/benchmark_results_summary.csv")
    write_paired_csv(rows, "Version 2 - Contamination/results/benchmark_results_paired.csv")

    print_summary(rows)

    print("\nFiles saved:")
    print("- Version 2 - Contamination/results/benchmark_results_detailed.csv")
    print("- Version 2 - Contamination/results/benchmark_results_summary.csv")
    print("- Version 2 - Contamination/results/benchmark_results_paired.csv")
